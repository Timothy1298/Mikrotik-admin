...
const ReferralsPage = lazy(() => import("@/pages/referrals/ReferralsPage").then((module) => ({ default: module.ReferralsPage })));
const UserManagementOverviewPage = lazy(() => import("@/pages/users/UserManagementOverviewPage").then((module) => ({ default: module.UserManagementOverviewPage })));
const UserManagementSectionPage = lazy(() => import("@/pages/users/UserManagementSectionPage").then((module) => ({ default: module.UserManagementSectionPage })));
const UserDetailsPage = lazy(() => import("@/pages/users/UserDetailsPage").then((module) => ({ default: module.UserDetailsPage })));
const RouterManagementOverviewPage = lazy(() => import("@/pages/routers/RouterManagementOverviewPage").then((module) => ({ default: module.RouterManagementOverviewPage })));
const RouterManagementSectionPage = lazy(() => import("@/pages/routers/RouterManagementSectionPage").then((module) => ({ default: module.RouterManagementSectionPage })));
const RouterDetailsPage = lazy(() => import("@/pages/routers/RouterDetailsPage").then((module) => ({ default: module.RouterDetailsPage })));
const RouterAddPage = lazy(() => import("@/pages/routers/RouterAddPage").then((module) => ({ default: module.RouterAddPage })));
const VpnServerManagementOverviewPage = lazy(() => import("@/pages/vpn-servers/VpnServerManagementOverviewPage").then((module) => ({ default: module.VpnServerManagementOverviewPage })));
const VpnServerManagementSectionPage = lazy(() => import("@/pages/vpn-servers/VpnServerManagementSectionPage").then((module) => ({ default: module.VpnServerManagementSectionPage })));
const VpnServerDetailsPage = lazy(() => import("@/pages/vpn-servers/VpnServerDetailsPage").then((module) => ({ default: module.VpnServerDetailsPage })));
const VpnClientsPage = lazy(() => import("@/pages/vpn-servers/VpnClientsPage").then((module) => ({ default: module.VpnClientsPage })));
const MonitoringOverviewPage = lazy(() => import("@/pages/monitoring/MonitoringOverviewPage").then((module) => ({ default: module.MonitoringOverviewPage })));
const MonitoringSectionPage = lazy(() => import("@/pages/monitoring/MonitoringSectionPage").then((module) => ({ default: module.MonitoringSectionPage })));
const MonitoringWorkspacePage = lazy(() => import("@/pages/monitoring/MonitoringWorkspacePage").then((module) => ({ default: module.MonitoringWorkspacePage })));
const BillingOverviewPage = lazy(() => import("@/pages/billing/BillingOverviewPage").then((module) => ({ default: module.BillingOverviewPage })));
const BillingSectionPage = lazy(() => import("@/pages/billing/BillingSectionPage").then((module) => ({ default: module.BillingSectionPage })));
const BillingRouterSubscriptionPage = lazy(() => import("@/pages/billing/BillingRouterSubscriptionPage").then((module) => ({ default: module.BillingRouterSubscriptionPage })));
const BillingAccountPage = lazy(() => import("@/pages/billing/BillingAccountPage").then((module) => ({ default: module.BillingAccountPage })));
const LogsSecurityOverviewPage = lazy(() => import("@/pages/logs-security/LogsSecurityOverviewPage").then((module) => ({ default: module.LogsSecurityOverviewPage })));
const LogsSecuritySectionPage = lazy(() => import("@/pages/logs-security/LogsSecuritySectionPage").then((module) => ({ default: module.LogsSecuritySectionPage })));
const LogsSecurityWorkspacePage = lazy(() => import("@/pages/logs-security/LogsSecurityWorkspacePage").then((module) => ({ default: module.LogsSecurityWorkspacePage })));
const SupportOverviewPage = lazy(() => import("@/pages/support/SupportOverviewPage").then((module) => ({ default: module.SupportOverviewPage })));
const SupportSectionPage = lazy(() => import("@/pages/support/SupportSectionPage").then((module) => ({ default: module.SupportSectionPage })));
const TicketDetailsPage = lazy(() => import("@/pages/support/TicketDetailsPage").then((module) => ({ default: module.TicketDetailsPage })));
const SettingsPage = lazy(() => import("@/pages/settings/SettingsPage").then((module) => ({ default: module.SettingsPage })));
const AdminManagementPage = lazy(() => import("@/pages/settings/AdminManagementPage").then((module) => ({ default: module.AdminManagementPage })));
const ResellersPage = lazy(() => import("@/pages/settings/ResellersPage").then((module) => ({ default: module.ResellersPage })));
const ServicePlansPage = lazy(() => import("@/pages/settings/ServicePlansPage").then((module) => ({ default: module.ServicePlansPage })));
