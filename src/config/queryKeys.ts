export const queryKeys = {
  ...
  proxyStatus: ["admin", "proxy-status"] as const,
  referrals: ["referrals"] as const,
  adminReferrals: ["admin-referrals"] as const,
  ...
  vpnClients: ["vpn-clients"] as const,
  vpnServerDetail: (id: string) => ["vpn-servers", id] as const,
  monitoring: ["monitoring"] as const,
  billing: ["billing"] as const,
  billingRouterSubscription: (routerId: string) => ["billing", "router-subscription", routerId] as const,
  logs: ["logs"] as const,
  support: ["support"] as const,
  settings: ["settings"] as const,
  resellerStatus: ["settings", "resellers"] as const,
